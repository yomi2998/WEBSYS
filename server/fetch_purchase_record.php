...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $result = $conn->query("SELECT e.event_name, e.image_link, r.price, r.quantity, r.purchase_date FROM recordpurchase r JOIN events e ON e.event_id = r.event_id WHERE r.username = '$username' ORDER BY e.event_date_time ASC");
